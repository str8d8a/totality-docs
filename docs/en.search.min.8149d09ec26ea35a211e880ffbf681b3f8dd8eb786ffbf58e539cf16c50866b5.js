...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/totality-docs/flexsearch.min.js');loadScript('/totality-docs/en.search-data.min.be9586ed08057a7c885acabae3fe5a2bd84326ddfc889c5b7bbc5ca9b0d0f13b.js',function(){input.required=false;search();});}
