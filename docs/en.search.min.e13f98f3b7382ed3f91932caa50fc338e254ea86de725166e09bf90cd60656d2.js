...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6f18be03e3dcf3a7bd945cd45a39ba436c1faba25ae606afae984c53d85d2cbc.js',function(){input.required=false;search();});}
