...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c0a092a9f7211318261c0c02fef74d3ead51a2aaa0f360e94b51a97847922247.js',function(){input.required=false;search();});}
